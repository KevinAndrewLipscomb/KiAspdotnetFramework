...
type
  ...
  strict private
    ...
    procedure LinkButton_num_requests_needing_finalization_Click(sender: System.Object; 
      e: System.EventArgs);
    procedure LinkButton_num_requests_needing_kind3_approval_Click(sender: System.Object; 
      e: System.EventArgs);
  ...
  strict protected
    ...
    Label_appropriated_to_kind1s: System.Web.UI.WebControls.Label;
    Label_requested_by_kind1s: System.Web.UI.WebControls.Label;
    ...
    LinkButton_num_requests_needing_kind3_approval: System.Web.UI.WebControls.LinkButton;
    ...
    LinkButton_maintain_kind1_accounts: System.Web.UI.WebControls.LinkButton;
    LinkButton_maintain_kind3_accounts: System.Web.UI.WebControls.LinkButton;
    LinkButton_maintain_kind2_accounts: System.Web.UI.WebControls.LinkButton;
...
/// </summary>
procedure TWebForm_kind2_overview.InitializeComponent;
begin
  ...
  Include(Self.LinkButton_num_requests_needing_kind3_approval.Click, Self.LinkButton_num_requests_needing_kind3_approval_Click);
...
procedure TWebForm_kind2_overview.Page_Load
  (
...
begin
  ...
  if not IsPostback then begin
    if (session['kind2_name'] = nil) or (session['kind2_user_id'] = nil) then begin
      session.Clear;
    ...
    Label_appropriated_to_kind1s.text := biz_appropriations.SumOfAppropriationsTokind1sInRegion
      (
      TClass_biz_kind2s.Create.RegionCodeOf(session['kind2_user_id'].tostring),
      TClass_biz_fiscal_years.Create.IdOfCurrent
      )
      .tostring('C');
    Label_requested_by_kind1s.text := biz_emsof_requests.SumOfRequestValues.tostring('C');
    ...
    LinkButton_num_requests_needing_finalization.text :=
      biz_emsof_requests.TallyOfStatus(NEEDS_KIND1_FINALIZATION) + LinkButton_num_requests_needing_finalization.text;
    LinkButton_num_requests_needing_kind3_approval.text :=
      biz_emsof_requests.TallyOfStatus(NEEDS_KIND3_APPROVAL) + LinkButton_num_requests_needing_kind3_approval.text;
    //
    ...
    waypoint_stack.Push('kind2_overview.aspx');
    session.Add('waypoint_stack',waypoint_stack);
    //
  end;
end;

procedure TWebForm_kind2_overview.OnInit(e: EventArgs);
begin
  //
...
procedure TWebForm_kind2_overview.LinkButton_missed_deadlines_Click(sender: System.Object;
  e: System.EventArgs);
begin
...
procedure TWebForm_kind2_overview.LinkButton_change_email_address_Click(sender: System.Object;
  e: System.EventArgs);
begin
  server.Transfer('change_email_address.aspx');
end;

procedure TWebForm_kind2_overview.LinkButton_change_password_Click(sender: System.Object;
  e: System.EventArgs);
begin
  server.Transfer('change_password.aspx');
end;

procedure TWebForm_kind2_overview.LinkButton_all_Click(sender: System.Object;
  e: System.EventArgs);
begin
  server.Transfer('all_emsof_requests.aspx');
end;

procedure TWebForm_kind2_overview.LinkButton_archived_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_deployed_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_rejected_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_withdrawn_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_completed_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_reimbursement_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_canceled_check_collection_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_invoice_collection_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_state_approval_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_transmittal_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_exec_dir_approval_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_num_requests_needing_kind3_approval_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
  session.Add('status_of_interest',NEEDS_KIND3_APPROVAL);
  server.Transfer('emsof_request_status_filter.aspx');
end;

procedure TWebForm_kind2_overview.LinkButton_num_requests_needing_finalization_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
  session.Add('status_of_interest',NEEDS_KIND1_FINALIZATION);
  server.Transfer('emsof_request_status_filter.aspx');
end;

procedure TWebForm_kind2_overview.LinkButton_num_requests_needing_development_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_regional_compliance_Click(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('status_of_interest');
...
procedure TWebForm_kind2_overview.LinkButton_logout_Click(sender: System.Object;
  e: System.EventArgs);
begin
