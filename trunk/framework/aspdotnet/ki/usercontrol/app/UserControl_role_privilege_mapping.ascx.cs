...
namespace UserControl_role_privilege_mapping
  {
    ...
    private struct p_type
      ...
      public string sort_order;
        ...
        {
            p.biz_role_privilege_map.Save(k.Safe(GridView_control.Rows[e.RowIndex].Cells[Static.CI_PRIVILEGE_ID].Text, k.safe_hint_type.NUM), k.Safe(GridView_control.Rows[e.RowIndex].Cells[Static.CI_ROLE_ID].Text, k.safe_hint_type.NUM), false);
            Bind();
        }
