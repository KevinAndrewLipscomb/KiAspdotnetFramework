...
namespace UserControl_role_notification_mapping
  ...
  public partial class TWebUserControl_role_notification_mapping : ki_web_ui.usercontrol_class
    ...
    private void GridView_control_RowDeleting(object sender, System.Web.UI.WebControls.GridViewDeleteEventArgs e)
      {
      p.biz.role_notification_map.Save
        (
        member_id: k.Safe(GridView_control.Rows[e.RowIndex].Cells[Static.CI_NOTIFICATION_ID].Text, k.safe_hint_type.NUM),
    ...
    protected void Button_add_Click(object sender, System.EventArgs e)
      {
      p.biz.role_notification_map.Save(k.Safe(DropDownList_notification.SelectedValue, k.safe_hint_type.NUM), k.Safe(DropDownList_role.SelectedValue, k.safe_hint_type.NUM), true);
      Bind();
      }
    ...
    private void Bind()
      {
      p.biz.role_notification_map.BindActuals(p.sort_order, p.be_sort_order_ascending, GridView_control);
      ...
      if (TableCell_add_mapping.Visible)
        ...
        p.biz.notifications.BindDirectToListControl(DropDownList_notification);
        }
