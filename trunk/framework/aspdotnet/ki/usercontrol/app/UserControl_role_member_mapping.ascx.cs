...
namespace UserControl_role_member_mapping
  ...
  public partial class TWebUserControl_role_member_mapping : ki_web_ui.usercontrol_class
    ...
    protected override void OnInit(EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.may_add_mappings = k.Has((string[])(Session["privilege_array"]), "config-roles-and-matrices")
          || k.Has((string[])(Session["privilege_array"]), "assign-department-roles-to-members")
          || k.Has((string[])(Session["privilege_array"]), "assign-squad-roles-to-members");
    ...
    private void TWebUserControl_role_member_mapping_PreRender(object sender, EventArgs e)
      {
    ...
    private void GridView_control_RowDataBound(object sender, GridViewRowEventArgs e)
      ...
      if (e.Row.RowType != DataControlRowType.EmptyDataRow)
        {
        be_ok_to_delete = p.be_interactive && p.biz.role_member_map.BePrivilegedToModifyTuple
          (
          has_config_roles_and_matrices:k.Has((string[])(Session["privilege_array"]), "config-roles-and-matrices"),
          has_assign_roles_to_members:k.Has((string[])(Session["privilege_array"]), "assign-roles-to-members"),
    ...
    private void Bind()
      {
      p.biz.role_member_map.BindActuals(p.sort_order, p.be_sort_order_ascending, GridView_control);
