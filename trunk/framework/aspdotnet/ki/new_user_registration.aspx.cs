      ...
      Form_control.Attributes.Add("onsubmit","SecurePassword()");
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                p.biz.users.RegisterNew(username, k.Safe(TextBox_nominal_password.Text, k.safe_hint_type.HEX), k.Safe(TextBox_email_address.Text, k.safe_hint_type.EMAIL_ADDRESS));
        ...
        {
            args.IsValid = !p.biz.users.BeRegisteredEmailAddress(k.Safe(args.Value, k.safe_hint_type.EMAIL_ADDRESS));
        }
        ...
        {
            args.IsValid = !p.biz.users.BeRegisteredUsername(k.Safe(args.Value, k.safe_hint_type.HYPHENATED_UNDERSCORED_ALPHANUM));
        }
