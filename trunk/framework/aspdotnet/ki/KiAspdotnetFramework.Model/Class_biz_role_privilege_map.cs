...
namespace Class_biz_role_privilege_map
  ...
  public class TClass_biz_role_privilege_map
    ...
    private readonly ITClass_db_role_privilege_map db_role_privilege_map = null;

    public TClass_biz_role_privilege_map(ITClass_db_role_privilege_map db_role_privilege_map_imp) : base() // CONSTRUCTOR
      {
      db_role_privilege_map = db_role_privilege_map_imp;
      }
