...
insert into kind1 (id,name) values
  (1, 'Name1 Kind1'),
  (2, 'Name2 Kind1'),
  (3, 'Name3 Kind1');

insert into kind2 (id,name) values
  (1, 'Name1 Kind2'),
  (2, 'Name2 Kind2'),
  (3, 'Name3 Kind2');

insert into kind3 (id,name) values
  (1, 'Name1 Kind3'),
  (2, 'Name2 Kind3'),
  (3, 'Name3 Kind3');
...
truncate table kind2_user;
INSERT INTO `kind2_user` (`id`, `encoded_password`, `be_stale_password`, `password_reset_email_address`, `be_active`) VALUES
(1, sha('kind2pass'), 0, 'finances@kvrs.org', 1),
(2, sha('kind2pass'), 0, 'finances@kvrs.org', 1),
(3, sha('kind2pass'), 0, 'finances@kvrs.org', 1),
(4, sha('kind2pass'), 0, 'finances@kvrs.org', 1);
