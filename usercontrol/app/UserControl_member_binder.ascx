  ...
  <table cellspacing="0" cellpadding="0" border="0">
	  ...
	  <tr>
		<td style="BORDER-RIGHT: silver thin solid; PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; BORDER-LEFT: silver thin solid; PADDING-TOP: 10px; BORDER-BOTTOM: silver thin solid">
		   <ASP:PlaceHolder id="PlaceHolder_resources" runat="server"></ASP:PlaceHolder>
		   <ASP:PlaceHolder id="PlaceHolder_config" runat="server"></ASP:PlaceHolder>
		   <ASP:PlaceHolder id="PlaceHolder_about" runat="server"></ASP:PlaceHolder>
		</td>
	  </tr>
  </table>
