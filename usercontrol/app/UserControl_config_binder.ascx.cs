  ...
  public partial class TWebUserControl_config_binder: ki_web_ui.usercontrol_class
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_member_binder_config_binder")
          {
          p.be_loaded &= ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_config_binder");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_config_binder")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_config_binder");
//        }
        //
